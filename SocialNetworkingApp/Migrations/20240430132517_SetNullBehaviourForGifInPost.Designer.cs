...
namespace SocialNetworkingApp.Migrations
{
    ...
    [Migration("20240430132517_SetNullBehaviourForGifInPost")]
    partial class SetNullBehaviourForGifInPost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialNetworkingApp.Models.GifAlbum", b =>
                {
                    b.HasOne("SocialNetworkingApp.Models.Gif", "Gif")
                        .WithOne("Album")
                        .HasForeignKey("SocialNetworkingApp.Models.GifAlbum", "GifId");
